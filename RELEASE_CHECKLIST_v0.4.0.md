...
- `R1` `depends_on: []`
  ...
  - Move current `Unreleased` notes into `## 0.4.0 - 2026-03-02`.
  - Ensure install snippet reflects `^0.4.0`.
...
- `R3` `depends_on: [R2]`
  - Write `VALIDATION_v0.4.0.md` with executed commands and outcomes.
...
- `R5` `depends_on: [R4]`
  - Verify `git show v0.4.0 --no-patch` resolves correctly.
