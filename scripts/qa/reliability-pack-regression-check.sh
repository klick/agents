...
expect_fixed "'incidents:read' => [" "$PLUGIN_ROOT/src/services/SecurityPolicyService.php" "Incident scope catalog entry missing"
expect_fixed "Read redacted agent incident snapshot" "$PLUGIN_ROOT/src/services/SecurityPolicyService.php" "Incident scope catalog description missing"
