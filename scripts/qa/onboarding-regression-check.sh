...
expect_fixed "machine identity your agent will use" "$START_TEMPLATE" "Onboarding create copy frames managed accounts as agent identities"
...
expect_fixed "You set the boundary first. Your agent works inside it." "$START_TEMPLATE" "Onboarding welcome copy explains the operator-first trust model"
