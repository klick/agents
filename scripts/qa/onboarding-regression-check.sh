...
expect_fixed "simulatePulse" "$START_TEMPLATE" "Onboarding start template supports URL-driven pulse simulation"
expect_fixed "onboardingStage !== 'welcome'" "$START_TEMPLATE" "Onboarding start template disables pulse simulation outside the welcome stage"
expect_fixed "agents-onboarding-hero-pulse" "$START_TEMPLATE" "Onboarding start template defines the onboarding hero pulse animation"
