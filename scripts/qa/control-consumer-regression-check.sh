...
expect_fixed "private const DASHBOARD_TABS = ['overview', 'readiness', 'discovery'];" "$DASHBOARD_CONTROLLER" "Dashboard controller collapses security into readiness tab set"
expect_fixed "return \$this->redirect('agents/dashboard/readiness#securitySnapshotSection');" "$DASHBOARD_CONTROLLER" "Legacy security route redirects to readiness security section"
