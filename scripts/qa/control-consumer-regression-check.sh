...
expect_fixed "id=\"securitySnapshotSection\"" "$DASHBOARD_TEMPLATE" "Dashboard security view exposes readiness-style security state card"
expect_fixed "Credential Inventory" "$DASHBOARD_TEMPLATE" "Dashboard security view exposes credential inventory proof section"
expect_fixed "id=\"securityActionMappingSection\"" "$DASHBOARD_TEMPLATE" "Dashboard security view exposes action mapping section"
